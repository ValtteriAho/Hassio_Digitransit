...
- Sensor icon automatically changes by next departure status (on time, late, early, scheduled)
- Each departure includes `status_icon` and `status_color` attributes for Lovelace styling (`green`, `red`, `dodgerblue`, `gray`)
